...
export function DocumentLetterhead({
  ...
  return (
    ...
    >
      ...
      {/* Main Content Area */}
      <div className="flex-1 px-10 py-8 z-10 bg-white text-gray-800 text-[13px] leading-relaxed relative">
        {(title || subtitle) && (
      ...
      <div className="shrink-0 px-10 py-4 text-[9px] text-gray-500 flex justify-between items-end print-footer mt-auto bg-gray-50 border-t border-gray-200">
