...
export default function Dashboard() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow-sm border-none rounded-lg p-6">
        <ul className="space-y-4">
          <li className="flex items-center gap-4">
            <div className="w-2 h-2 bg-blue-500 rounded-full shrink-0"></div>
            <p className="text-sm text-slate-600 flex-1">
              Certificado NR-35 criado para <span className="font-semibold">João Silva</span>
            </p>
            <span className="text-xs text-slate-400 bg-slate-50 px-2 py-1 rounded">Há 2 horas</span>
          </li>
          <li className="flex items-center gap-4">
            <div className="w-2 h-2 bg-green-500 rounded-full shrink-0"></div>
            <p className="text-sm text-slate-600 flex-1">
              Orçamento aprovado para <span className="font-semibold">Construtora Alpha</span>
            </p>
            <span className="text-xs text-slate-400 bg-slate-50 px-2 py-1 rounded">Há 5 horas</span>
          </li>
          <li className="flex items-center gap-4">
            ...
            <span className="text-xs text-slate-400 bg-slate-50 px-2 py-1 rounded">Ontem</span>
          </li>
        </ul>
      </div>
    </div>
